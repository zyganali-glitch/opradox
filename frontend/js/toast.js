/**
 * OPRADOX CENTRAL TOAST SYSTEM (FAZ-5 + FAZ-ES-1)
 * Minimal, standalone toast notifications
 * Used by: Visual Studio, Excel Studio, Hub, etc.
 * 
 * NON-OVERRIDING GUARD: If showToast is already defined (by another script),
 * this file will NOT override it. This ensures compatibility across all pages.
 */

// Guard: Do not override if already defined
if (window.showToast) {
    console.log('[TOAST] showToast already defined, keeping existing implementation');
} else {
